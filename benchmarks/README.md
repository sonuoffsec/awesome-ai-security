...
| Benchmark | Description | Link |
|---|---|---|
| **RAGAS** | RAG evaluation across faithfulness, relevance, correctness | [GitHub](https://github.com/explodinggradients/ragas) |
| **RGB** | Retrieval-augmented generation benchmark | [GitHub](https://github.com) |

---

## Contributing Benchmarks

Know an evaluation framework that belongs here? Submit a PR.
